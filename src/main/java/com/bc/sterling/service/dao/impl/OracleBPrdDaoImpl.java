...
@Repository("oracleBprdDao")
public class OracleBPrdDaoImpl extends SQLBaseDaoImpl implements OracleDao {

	@Autowired
	public OracleBPrdDaoImpl(@Qualifier("BprdPeoplesoftDS") DataSource ds) {
		super(ds);
	}
