...
@Repository("oracleHmigDao")
public class OracleHMigDaoImpl extends SQLBaseDaoImpl implements OracleDao {

	@Autowired
	public OracleHMigDaoImpl(@Qualifier("HmigPeoplesoftDS") DataSource ds) {
		super(ds);
	}
