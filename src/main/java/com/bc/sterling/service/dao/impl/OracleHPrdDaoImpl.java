...
@Repository("oracleHprdDao")
public class OracleHPrdDaoImpl extends SQLBaseDaoImpl implements OracleDao {

	@Autowired
	public OracleHPrdDaoImpl(@Qualifier("HprdPeoplesoftDS") DataSource ds) {
		super(ds);
	}
