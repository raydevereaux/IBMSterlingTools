...
@Repository("sterlingPrdDao")
public class SterlingPrdDaoImpl extends SQLBaseDaoImpl implements SterlingDao {

	@Autowired
	public SterlingPrdDaoImpl(@Qualifier("SterlingDataSourcePrd") DataSource ds) {
		super(ds);
	}
