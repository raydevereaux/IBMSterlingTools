...
@Repository("oracleBmignDao")
public class OracleBMigDaoImpl extends SQLBaseDaoImpl implements OracleDao {

	@Autowired
	public OracleBMigDaoImpl(@Qualifier("BmigPeoplesoftDS") DataSource ds) {
		super(ds);
	}
