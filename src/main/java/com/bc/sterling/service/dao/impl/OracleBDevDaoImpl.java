...
@Repository("oracleBdevDao")
public class OracleBDevDaoImpl extends SQLBaseDaoImpl implements OracleDao {

	@Autowired
	public OracleBDevDaoImpl(@Qualifier("BdevPeoplesoftDS") DataSource ds) {
		super(ds);
	}
