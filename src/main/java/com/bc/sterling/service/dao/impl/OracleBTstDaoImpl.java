...
@Repository("oracleBtstDao")
public class OracleBTstDaoImpl extends SQLBaseDaoImpl implements OracleDao {

	@Autowired
	public OracleBTstDaoImpl(@Qualifier("BtstPeoplesoftDS") DataSource ds) {
		super(ds);
	}
