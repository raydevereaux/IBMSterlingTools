...
public class UpdateBccDBServer_sproc extends MSSQLBaseStoredProcedure {
	private static final SimpleDateFormat df = new SimpleDateFormat("MM/dd/yyyy");
    protected static final String SPROC_NAME = "dbo.UpdateBccDBServer";

    public UpdateBccDBServer_sproc(DataSource ds) {
          super(ds);
          setSql(SPROC_NAME);
