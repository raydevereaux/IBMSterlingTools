...
@Repository("oracleHdevDao")
public class OracleHDevDaoImpl extends SQLBaseDaoImpl implements OracleDao {

	@Autowired
	public OracleHDevDaoImpl(@Qualifier("HdevPeoplesoftDS") DataSource ds) {
		super(ds);
	}
