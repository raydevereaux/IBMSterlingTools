...
public class DatasourcesOracle {
	...
	public DataSource getHmigPeoplesoftDS() {
	    ...
	    ds.setUrl("jdbc:oracle:thin:@bouxdora02.bc.com:1521:HMIG");
	...
	public DataSource getHdevPeoplesoftDS() {
		DriverManagerDataSource ds = new DriverManagerDataSource();
	    ds.setDriverClassName("oracle.jdbc.OracleDriver");
	    ds.setUrl("jdbc:oracle:thin:@bouxdora02.bc.com:1521:HDEV");
	    ds.setUsername("IB_OQ");
	    ds.setPassword("B01se17");
	    return ds;
	}
	...
	public DataSource getHtstPeoplesoftDS() {
		DriverManagerDataSource ds = new DriverManagerDataSource();
	    ds.setDriverClassName("oracle.jdbc.OracleDriver");
	    ds.setUrl("jdbc:oracle:thin:@bouxdora02.bc.com:1521:HTST");
	    ds.setUsername("IB_OQ");
	    ds.setPassword("B01se17");
	    return ds;
	}
	...
	public DataSource getHprdPeoplesoftDS() {
		DriverManagerDataSource ds = new DriverManagerDataSource();
	    ds.setDriverClassName("oracle.jdbc.OracleDriver");
	    ds.setUrl("jdbc:oracle:thin:@bouxpora02.bc.com:1521:HPRD");
	    ds.setUsername("IB_OQ");
	    ds.setPassword("B01se17");
	    return ds;
	}
